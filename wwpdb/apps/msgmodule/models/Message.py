...
class Message(object):
    ...
    def fromReqObj(p_reqObj,verbose=True,log=sys.stderr):
        ...
        msgDict["send_status"] = sendStatus if sendStatus else "Y" # set to "Y" or "N" for "live" vs. "draft", in all other contexts such as archive,forward,autoMsg --> this is "Y"
    ...
    def isReminderMsg(self):
        ...
        '''
        return self._bIsReminderMsg == True
