...
# 29-Apr-2012         Ported here to msgmodule package
# 17-Mar-2014    RPS  Updated printIt for UTF-8 handling
# 04-Jun-2014    RPS  added getSessionPath() to MessagingInputRequest
# 04-May-2018    EP   use application neutral SessionManager
##
"""
...
class MessagingInputRequest(WebRequest):
    def __init__(self,paramDict,verbose=False,log=sys.stderr):
        super(MessagingInputRequest,self).__init__(paramDict,verbose)
        self.__verbose = verbose
        self.__lfh=log
