...
class MessagingDataImport(object):
    ...
    def getMileStoneFilePaths(self,contentType,format,version='latest',partitionNum=None):
        ...
        pathDict['annotPth'] = self.__getWfFilePath(contentType=contentType,format=format,fileSource=self.__fileSource,version=version,createAsNeeded=False,partitionNum=partitionNum)
        return pathDict
