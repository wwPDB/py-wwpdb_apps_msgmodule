...
class TestCifDatabaseRoundTrip(unittest.TestCase):
    ...
    def _validate_round_trip(self, original_data: Dict, exported_data: Dict, content_type: str):
        ...
        print("      - All message_ids preserved")
        print("      - All subjects preserved")
        print("      - All message text preserved")
    ...
    def test_notes_from_annotator_round_trip(self):
        ...
        if os.path.isdir(dep_output_dir):
            ...
            if not matching_files:
                ...
                print("   ⚠️  No notes-from-annotator file found. This may indicate:")
                print("      - No notes exist in database for this deposition")
                print("      - Notes were stored under a different content_type")
                print("      - Export logic doesn't handle notes-from-annotator")
...
"""
        ...
        print("   📝 Creating message in database with non-ASCII text...")
        migrator = CifToDbMigrator(self.site_id)
        ...
        try:
            ...
            with open(exported_cif, 'r', encoding='utf-8') as f:
                ...
                print("   ✅ CIF contains Unicode escape sequences")

            # Step 3: Delete original message from database
            print("   🗑️  Deleting original message from database...")
            ...
            print("   🔍 Comparing original vs re-imported message...")
            ...
            print("      - Special chars verified: α, 你好, café, 🧬, etc.")
            print("   ✅ Non-ASCII round-trip validation successful!")
